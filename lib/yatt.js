...
(function (yatt) {
    ...
    yatt.setLogger(new Logger({
        testsWin: null,
        print: function (msg) {
            jQuery('#test_log', this.testsWin.document).append(msg);
            jQuery('#test_results', this.testsWin.document).scrollTop(999999);
        },
        ready: function (fn) {
            this.onReady = fn;
            if (!this.testsWin) {
        ...
        start: function (count) {
            jQuery('#test_log', this.testsWin.document).empty();
        ...
        pass: function (idx, name, suite) {
            jQuery('#test_log #test_' + idx, this.testsWin.document).css('color', 'green').append(' - Ok');
        },
        fail: function (idx, name, suite, actual, expected, message, operator) {
            ...
            jQuery('#test_log #test_' + idx, this.testsWin.document).css('color', 'red').append(' - Fail');
        },
